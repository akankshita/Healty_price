...
set :keep_releases, 5
set :application,   'healthyprice'
set :repository,    'git@github.com:galori/healthyprice.git'
...
set :production_database,'healthyprice_production'
...
task :healthyprice_staging do
  role :web, '75.101.142.10'
  role :app, '75.101.142.10'
  role :db, '75.101.142.10', :primary => true
  set :environment_database, Proc.new { production_database }
  set :dbuser,        'hpuser'
  set :dbpass,        '1SkgnlhGUg'
  set :user,          'hpuser'
  set :password,      '1SkgnlhGUg'
  set :runner,        'hpuser'
